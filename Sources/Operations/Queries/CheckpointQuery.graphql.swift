...
public class CheckpointQuery: GraphQLQuery {
  public static let operationName: String = "checkpoint"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query checkpoint($digest: String) { checkpoint(id: { digest: $digest }) { __typename digest sequenceNumber validatorSignature previousCheckpointDigest networkTotalTransactions rollingGasSummary { __typename computationCost storageCost storageRebate nonRefundableStorageFee } epoch { __typename epochId referenceGasPrice startTimestamp endTimestamp } endOfEpoch { __typename nextProtocolVersion } } }"#
    ))

  public var digest: GraphQLNullable<String>

  public init(digest: GraphQLNullable<String>) {
    self.digest = digest
  }

  public var __variables: Variables? { ["digest": digest] }
  ...
  public struct Data: SUIAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("checkpoint", Checkpoint?.self, arguments: ["id": ["digest": .variable("digest")]]),
    ] }
