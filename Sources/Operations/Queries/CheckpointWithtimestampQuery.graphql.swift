...
public class CheckpointWithtimestampQuery: GraphQLQuery {
  public static let operationName: String = "checkpointWithtimestamp"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query checkpointWithtimestamp { checkpoint { __typename digest sequenceNumber timestamp liveObjectSetDigest transactionBlockConnection { __typename edges { __typename node { __typename digest expiration { __typename epochId } } } } } }"#
    ))
