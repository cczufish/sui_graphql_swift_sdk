...
public class CheckpointConnectionQuery: GraphQLQuery {
  public static let operationName: String = "checkpointConnection"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query checkpointConnection { checkpointConnection { __typename nodes { __typename digest sequenceNumber validatorSignature previousCheckpointDigest networkTotalTransactions rollingGasSummary { __typename computationCost storageCost storageRebate nonRefundableStorageFee } epoch { __typename epochId referenceGasPrice startTimestamp endTimestamp } endOfEpoch { __typename nextProtocolVersion } } } }"#
    ))
  ...
  public struct Data: SUIAPI.SelectionSet {
    ...
    public struct CheckpointConnection: SUIAPI.SelectionSet {
      ...
      public struct Node: SUIAPI.SelectionSet {
        ...
        /// CheckpointConnection.Node.RollingGasSummary
        ///
        ...
        /// CheckpointConnection.Node.Epoch
        ///
        /// Parent Type: `Epoch`
        ...
        /// CheckpointConnection.Node.EndOfEpoch
        ///
