...
public class EpochWithTxBlockConnectionLatestQuery: GraphQLQuery {
  public static let operationName: String = "epochWithTxBlockConnectionLatest"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query epochWithTxBlockConnectionLatest { epoch { __typename transactionBlockConnection(first: 20, after: "261225985") { __typename pageInfo { __typename hasNextPage endCursor } edges { __typename cursor node { __typename gasInput { __typename gasPrice gasBudget } } } } } }"#
    ))
