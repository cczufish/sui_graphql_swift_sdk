...
public class CheckpointWithSequenceNumberQuery: GraphQLQuery {
  public static let operationName: String = "checkpointWithSequenceNumber"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query checkpointWithSequenceNumber($sequenceNumber: Int!) { checkpoint(id: { sequenceNumber: $sequenceNumber }) { __typename digest sequenceNumber validatorSignature previousCheckpointDigest networkTotalTransactions rollingGasSummary { __typename computationCost storageCost storageRebate nonRefundableStorageFee } epoch { __typename epochId referenceGasPrice startTimestamp endTimestamp } endOfEpoch { __typename nextProtocolVersion } } }"#
    ))
